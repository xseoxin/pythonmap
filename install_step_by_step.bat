@echo off
title Google Maps Position Checker - Instalator
color 0A
...
echo ========================================================
echo.
echo Witaj! Ten skrypt pomoze Ci zainstalowac aplikacje.
echo.
echo ========================================================
echo.
...
echo [KROK 2/3] Aktualizacja pip...
echo.
...
echo [KROK 3/3] Instalowanie zaleznosci...
echo.
...
echo --------------------------------------------------------
echo.
echo 1. Uruchom aplikacje (run.bat)
echo 2. Kliknij "Nowy Projekt"
echo 3. Dodaj nazwe firmy i wspolrzedne z Google Maps
echo 4. Dodaj frazy (np. "pizza", "restauracja")
echo 5. Kliknij "Sprawdz Pozycje"
echo 6. Zobacz wyniki na mapie!
echo.
echo --------------------------------------------------------
echo.
